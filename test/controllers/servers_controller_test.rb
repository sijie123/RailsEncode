...
class ServersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create server" do
    assert_difference('Server.count') do
      post servers_url, params: { server: { ip: @server.ip, name: @server.name, threads: @server.threads } }
    end
  ...
  test "should update server" do
    patch server_url(@server), params: { server: { ip: @server.ip, name: @server.name, threads: @server.threads } }
